      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-stretch">
          ...
          <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item nav-profile dropdown" style="display:none;">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="http://localhost/pandemic/index.php">
            ...
            <li class="nav-item">
              <a class="nav-link" href="http://localhost/pandemic/dashboard/admin.php">
            ...
            <li class="nav-item">
              <a class="nav-link" href="http://localhost/pandemic/dashboard/pages/forms/form.php">
                <span class="icon-bg"><i class="mdi mdi-format-list-bulleted menu-icon"></i></span>
                        ...
                        <div class="card">
                          <div class="card-body">
                            <div class="row">
                              ...
                              <div class="col-lg-6 col-sm-2 grid-margin  grid-margin-lg-0" style="border-bottom:black;border-style:solid;">
                                <div class="wrapper pb-2 " style="">
                                 <h4 class="mb-0 text-dark font-weight-bold"><?php echo$info['hname'];?></h4><br>
                                  <div class="text-wrapper d-flex align-items-center justify-content-between mb-2">
                                    <b class="mb-0 text-dark">Total bed</b>
                                    <span class="text-success"><i class="mdi mdi-arrow-up"></i><?php echo$info['tvb'];?></span>
                                  </div>
                                  <p class="mb-0 text-dark font-weight-bold"><?php echo$info['addr'];?></p>
                                  <br><br><br>
                                </div>
                              </div> 
                              <?php  }   } ?>
